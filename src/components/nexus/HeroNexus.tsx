    ...
    <section className="relative flex min-h-[92vh] items-center justify-center overflow-hidden px-6 pt-32">
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <h1 className="font-display text-5xl font-bold leading-tight tracking-tight sm:text-7xl md:text-8xl">
          <span className="block text-foreground">نكسس</span>
          <span className="block neon-text">من المستقبل</span>
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
          مركز تحكم زجاجي يجمع كل مشاريعك الرقمية في فضاء واحد.
          منصة، خدمات، ذكاء اصطناعي، تجارة، عقارات، نقل — كل شيء في مكان واحد.
        </p>

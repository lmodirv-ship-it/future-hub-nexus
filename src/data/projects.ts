...
export const PROJECTS: NexusProject[] = [
  {
    id: "1", slug: "ai-studio-vision", name: "AI Studio Vision",
    nameAr: "استوديو الرؤية الذكية", tagline: "توليد فيديوهات بالذكاء الاصطناعي",
  ...
  {
    id: "2", slug: "ai-scene-studio", name: "AI Scene Studio",
    nameAr: "استوديو المشاهد الذكية", tagline: "إنشاء مشاهد سينمائية بالذكاء الاصطناعي",
  ...
  {
    id: "4", slug: "souk-hn", name: "Souk-HN Express",
    nameAr: "سوق HN السريع", tagline: "منصة تجارة إلكترونية حديثة",
  ...
  {
    id: "5", slug: "agency-hub-pro", name: "Agency Hub Pro",
    nameAr: "وكالة العقارات الاحترافية", tagline: "إدارة العقارات والوكالات",
  ...
  {
    id: "6", slug: "profitable-ventures", name: "Profitable Ventures Hub",
    nameAr: "مركز المشاريع المربحة", tagline: "اكتشف فرص الاستثمار الذكية",
  ...
  {
    id: "8", slug: "smart-solutions", name: "Smart Solutions Hub",
    nameAr: "مركز الحلول الذكية", tagline: "حلول رقمية متكاملة للأعمال",
  ...
  {
    id: "9", slug: "tangier-print", name: "Grand Tanger Print Studio",
    nameAr: "استوديو طنجة الكبرى للطباعة", tagline: "خدمات طباعة وتصميم احترافية",
  ...
  {
    id: "10", slug: "carwash-manager", name: "CarWashManager",
    nameAr: "مدير غسيل السيارات", tagline: "إدارة محطات غسيل السيارات",
  ...
  {
    id: "11", slug: "wash-pal", name: "WashPal",
    nameAr: "رفيق الغسيل", tagline: "نسخة محسّنة لإدارة غسيل السيارات",
  ...
  {
    id: "13", slug: "domain-monitor", name: "Domain Monitor",
    nameAr: "مراقب النطاقات", tagline: "مراقبة أداء وحالة النطاقات",
  ...
  {
    id: "14", slug: "cloud-harmony", name: "Cloud Harmony",
    nameAr: "تناغم السحابة", tagline: "إدارة الخدمات السحابية بسلاسة",

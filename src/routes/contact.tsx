    ...
    <section className="relative mx-auto max-w-4xl px-6 pb-20 pt-32">
      <div className="text-center">
        <h1 className="font-display text-5xl font-bold">
          <span className="neon-text">تواصل</span> معنا
        </h1>
        <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
          نحب أن نسمع منك — أرسل لنا رسالة وسنعود إليك بأسرع وقت.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-[1fr_2fr]">
        <div className="space-y-4">
          <div className="glass rounded-2xl p-5">
            ...
            <h3 className="mt-3 font-display font-bold">البريد</h3>
            <p className="mt-1 text-sm text-muted-foreground">hello@nexus.app</p>
          </div>
          <div className="glass rounded-2xl p-5">
            <MessageSquare className="h-6 w-6 text-[oklch(0.7_0.28_330)]" />
            <h3 className="mt-3 font-display font-bold">دردشة فورية</h3>
            <p className="mt-1 text-sm text-muted-foreground">متاح على مدار الساعة</p>
          </div>
          <div className="glass rounded-2xl p-5">
            <Sparkles className="h-6 w-6 text-[oklch(0.65_0.25_290)]" />
            <h3 className="mt-3 font-display font-bold">مساعد ذكي</h3>
            <p className="mt-1 text-sm text-muted-foreground">قريباً — مدعوم بالـ AI</p>
          </div>
        </div>
        ...
        >
          {sent ? (
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <h3 className="mt-4 font-display text-2xl font-bold">تم الإرسال!</h3>
              <p className="mt-2 text-sm text-muted-foreground">سنعود إليك قريباً.</p>
            </div>
          ) : (
            <div className="space-y-4">
              <div>
